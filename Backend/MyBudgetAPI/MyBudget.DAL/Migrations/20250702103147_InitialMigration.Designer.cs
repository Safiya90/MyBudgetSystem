...
namespace MyBudget.DAL.Migrations
{
    ...
    [Migration("20250702103147_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBudgetAPI.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MyBudgetAPI.Models.Expense", b =>
                {
                    b.HasOne("MyBudgetAPI.Models.ApplicationUser", null)
                        .WithMany("Expenses")
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("MyBudgetAPI.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
